...
# 1. registra le prime modifiche
cronologia.insertLast("admin")
cronologia.insertLast("mario")
cronologia.insertLast("sara")

print(f"1. {cronologia}")

cronologia.insertAfter("mario", "guest")

print(f"2. {cronologia}")

cronologia.insertBefore("admin", "root")

print(f"3. {cronologia}")

cronologia.insertBefore("sara", "luca")

print(f"4. {cronologia}")

cronologia.removeFirst()

print(f"5. {cronologia}")

cronologia.removeLast()

print(f"6. {cronologia}")

print(f"7. modifiche registrate: {cronologia.size()}")

print(f"8. modifica più recente: {cronologia.peekFirst()}")